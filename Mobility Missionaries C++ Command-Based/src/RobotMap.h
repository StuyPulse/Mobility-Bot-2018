...
#include <string>
    ...
    constexpr int FRONT_RIGHT_MOTOR_CHANNEL = 1;
    constexpr int REAR_RIGHT_MOTOR_CHANNEL = 2;
    constexpr int REAR_LEFT_MOTOR_CHANNEL = 3;
    constexpr int FRONT_LEFT_MOTOR_CHANNEL = 4;
